...
#
# Generated by export_simulation on Wed Apr 09 14:12:49 IST 2025
#
################################################################################
...
'-reset_run' switch to the './SeedMem512.sh' script.

./SeedMem512.sh -reset_run
...
./SeedMem512.sh -noclean_files

For more information on the script, please type './SeedMem512.sh -help'.
